...
public class GameVO {
	...
	private String notice_view; //(공) 제목
	...
	public void setGame_level(int setGame_level) {
		this.game_level = setGame_level;
	}
	...
	public String briefShow() {
		...
		return nickname + " " + game_level + " " + game_jobs + " " + log_status+ " " +crt_location + " "+ n_mail ;
	}
